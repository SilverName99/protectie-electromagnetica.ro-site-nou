...
Migrare `protectie-electromagnetica.ro` din WordPress/WooCommerce către un magazin custom PHP (backend copiat din `Mutare-Site-Biovitality`). Pentru importul automat al conținutului vechi vezi [MIGRARE.md](MIGRARE.md).
