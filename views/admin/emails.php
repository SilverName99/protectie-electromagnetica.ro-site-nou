        ...
        <form method="post" action="/admin/emails" class="form-grid">
            ...
            <div class="field">
                ...
                <input
                    ...
                    value="<?= htmlspecialchars((string) ($settings['order_email_from_name'] ?? 'Protecție Electromagnetică'), ENT_QUOTES) ?>"
                >
            </div>
            <div class="field">
            ...
            <article class="panel" style="margin-top:12px;">
                ...
                <div id="contact-instructions-body">
                    <p style="margin:0 0 10px;color:#64748b;">
                        Ca formularul să trimită corect către <strong>contact@protectie-electromagnetica.ro</strong>, trebuie să respecte pașii de mai jos.
                    </p>
