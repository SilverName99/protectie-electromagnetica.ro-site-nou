...
$mobileMenuLogoPath = '/uploads/gallery/protectie-electromagnetica-logo.png';
...
$siteBaseTitle = trim((string) ($designSettings['store_name'] ?? 'Protecție Electromagnetică'));
if ($siteBaseTitle === '') {
    $siteBaseTitle = 'Protecție Electromagnetică';
}
    ...
    <?php else: ?>
        <header class="header">
            <div class="container site-container header-inner">
                <a href="/" class="logo">Protecție Electromagnetică (Custom)</a>
                <nav class="nav">
