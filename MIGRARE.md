# Migrare conținut din protectie-electromagnetica.ro (site-ul vechi)

Backend-ul din acest repo este o copie a platformei custom PHP (magazin + blog + admin)
din `Mutare-Site-Biovitality`, adaptată pentru **Protecție Electromagnetică**.
...
Sursa implicită este `https://protectie-electromagnetica.ro`. O poți schimba cu `--source=`.
