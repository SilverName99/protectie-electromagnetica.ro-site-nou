...
final class SiteController
{
    ...
    public function contactSend(): void
    {
        ...
        $settings = Settings::all($db);
        $to = 'contact@protectie-electromagnetica.ro';
    ...
    public function newsletterTrackClick(array $params): void
    {
        ...
        $fallback = 'https://protectie-electromagnetica.ro';
...
HTML;
    ...
    private function buildBlogTemplateRender(array $post): array
    {
        ...
        $authorName = trim((string) ($post['author_name'] ?? 'Protecție Electromagnetică'));
